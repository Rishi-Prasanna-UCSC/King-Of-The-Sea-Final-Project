...
let config = {
    ...
    width: widthScreen,
    height: heightScreen,
    scene: [Intro, Menu, Levels, One, Pause, Tutorial, TutorialTwo, LevelComplete, GameOver, Two, StoryOne, StoryTwo, StoryThree, Three],
    // scene: [LevelComplete], // Debug
    // scene: [Three, Pause, LevelComplete, GameOver],
    physics: {
        default: 'arcade',
        arcade: {
            // debug: false
